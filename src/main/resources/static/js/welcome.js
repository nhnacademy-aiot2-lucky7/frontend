document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        ...
        welcomeContainer.style.transition = 'transform 1s ease-in-out';
    ...
    buttonContainer.style.transition = 'opacity 1.0s ease-in-out'; // 버튼 표시 시간 관련
...
// 버튼 생성 - 원형 버튼으로 수정
    ...
    const buttonUrls = ['sign-in', 'sign-up', 'dashboard'];
